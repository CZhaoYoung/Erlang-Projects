...
%% Zhaoyang Chen
%% 
%% This module create an actor per client connection. 
...
-export([initialize/0, register_user/0, subscribe/3,
...
% where X is defined by # DataActor
initialize() ->
...
% data actor works like a small database and encapsulates all states
data_actor(Data) ->
    receive        
...
% entry actor just delegates to the data actor
entry_actor() ->
